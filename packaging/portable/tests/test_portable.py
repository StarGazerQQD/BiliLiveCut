...
覆盖:
- Source Snapshot (92618ef 解析/提取/Overlay)
...
class TestSourceSnapshot:
    ...
    def test_commit_resolvable(self) -> None:
        ...
        full = resolve_commit("92618ef")
        assert len(full) == 40
        assert full == "92618efcb9a3d6ec33f5ce3e0b2f46ac7e2cf55a"
    ...
    def test_extract_contains_app_cli(self, tmp_worktree: str) -> None:
        ...
        report = extract_source("92618ef", staging)
        assert report["source_commit_short"] == "92618ef"
