...
class TestIdentityFields:
    ...
    def test_core_source_commit_is_current_baseline(self, manifest: dict) -> None:
        ...
        assert manifest["core_source_commit"] == "99c9f1697866cce9f0920b7f1ed04249e0d81b12"
        assert manifest["core_source_commit_short"] == "99c9f16"
        assert manifest["source_commit"] == manifest["core_source_commit"]
        assert manifest["source_commit_short"] == "99c9f16"
