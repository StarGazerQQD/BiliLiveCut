...
class TestIdentityFields:
    ...
    def test_core_source_commit_is_current_baseline(self, manifest: dict) -> None:
        ...
        assert manifest["core_source_commit"] == "0ea5c2a764d80f6afa5119febcfeeff60a8019e5"
        assert manifest["core_source_commit_short"] == "0ea5c2a"
        assert manifest["source_commit"] == manifest["core_source_commit"]
        assert manifest["source_commit_short"] == "0ea5c2a"
