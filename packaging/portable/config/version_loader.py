...
用法:
    ...
    print(RELEASE_VERSION)  # "0.1.15-alpha"
...
def get_lite_exe_name() -> str:
    ...
    :returns: 如 "BiliLiveCut-Portable-Lite-v0.1.15-alpha-x64.exe"
    """
...
def get_full_zip_name() -> str:
    ...
    :returns: 如 "BiliLiveCut-Portable-Full-0.1.15-alpha-x64.zip"
    """
...
def get_engine_pack_zip_name() -> str:
    ...
    :returns: 如 "BiliLiveCut-EnginePack-0.1.15-alpha.zip"
    """
