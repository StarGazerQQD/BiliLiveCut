...
- **手动编译**: 安装 [Visual Studio Build Tools](https://visualstudio.microsoft.com/zh-hans/downloads/)（勾选「C++ 桌面开发」），然后:
  ```powershell
  python setup_c.py build_ext --inplace
  ```
- **启动确认**: 查看日志 `加速模块: C 扩展已加载` 或 `加速模块: 使用纯 Python 后备`
- **主要提速**: 关键词匹配 (20-50×)、弹幕情绪 (10-30×)、主题聚类 (5-15×)、弹幕基线 (10-30×)、SRT 组装 (3-8×)
