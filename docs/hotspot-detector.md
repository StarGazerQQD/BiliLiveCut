...
适用版本：`0.1.18.2-alpha`。用户操作流程见[项目 README](../README.md)和 [Portable 小白使用说明](../packaging/portable/USER_GUIDE_ZH.md)；V0.1.17 基于分段峰值的历史实现与修复记录见 [0.1.17 系列 Changelog](changelog/CHANGELOG_PRE_0.1.17.md)。
